<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\wwwroot\154.48.235.148/application/dsadmin/view/gongyou/add.html";i:1530694748;s:69:"D:\wwwroot\154.48.235.148/application/dsadmin/view/public/header.html";i:1484102488;s:69:"D:\wwwroot\154.48.235.148/application/dsadmin/view/public/footer.html";i:1529869102;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" name="add" id="add" method="post" action="add">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="photo" type="text" class="form-control" name="photo" placeholder="输入缩略图地址" >
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        function checkForm(){
            if( '' == $.trim($('#url').val())){
                layer.msg('视频外链不能为空', {icon: 5,time:1500,shade: 0.1}, function(index){
                    layer.close(index);
                });
                return false;
            }
