<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"/var/www/html/ship/application/dsadmin/view/index/index.html";i:1539350776;s:62:"/var/www/html/ship/application/dsadmin/view/public/header.html";i:1484102488;s:62:"/var/www/html/ship/application/dsadmin/view/public/footer.html";i:1529869102;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="row">
			...
			<div class="col-sm-4">
                <div class="ibox float-e-margins">
                    ...
                    <div class="panel-body">
                        <p>本打赏系统仅供作为正规视频传输吸粉收费系统，禁止利用程序从事违法活动。正规视频传输收费系统之用，切勿利用本程序从事商业违法行为。用户上传内容一律与本系统制作者无关，由使用用户自行承担！如用于其他用途所产生的一切不良后果本人概不负责！本系统由天易工作室开发，请勿使用违法行为</p>
