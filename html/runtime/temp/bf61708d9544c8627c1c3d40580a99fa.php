<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/www/wwwroot/dsds.test.sdgtwz.com/application/dsadmin/view/dlmenu/index.html";i:1529953262;s:77:"/www/wwwroot/dsds.test.sdgtwz.com/application/dsadmin/view/public/header.html";i:1484102488;s:77:"/www/wwwroot/dsds.test.sdgtwz.com/application/dsadmin/view/public/footer.html";i:1529869102;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title">添加代理菜单</h3>                  
                </div>
                <form class="form-horizontal" name="add_rule" id="add_rule" method="post" action="<?php echo url('add_rule'); ?>">
                    <div class="ibox-content">
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">代理菜单名称</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <span class="help-block m-b-none">如：dsadmin/user/adduser (一级节点添加“#”即可)</span>
                                </div>
                            </div>  
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
        ...
        function complete(data){
            if(data.code==1){
                layer.msg(data.msg, {icon: 6,time:1500,shade: 0.1}, function(index){
                    window.location.href="<?php echo url('dlmenu/index'); ?>";
                });
            }else{
...
function rule_state(id){
    dashang.status(id,'<?php echo url("rule_state"); ?>');
}
