<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\wwwroot\154.48.235.148/application/daili/view/user/fanyong.html";i:1530662870;s:67:"D:\wwwroot\154.48.235.148/application/daili/view/public/header.html";i:1530177288;s:67:"D:\wwwroot\154.48.235.148/application/daili/view/public/footer.html";i:1529869102;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="<?php if($ismobile==0): ?>wrapper wrapper-content<?php endif; ?> animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
			...
			<!--搜索框开始-->           
            <div class="row">
                 <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('fanyong'); ?>">
                        <div class="col-sm-6">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        var key=$('#key').val();
		var riqi=$('#riqi').val();
        $.getJSON('<?php echo url("fanyong"); ?>', {page: curr || 1,riqi:riqi}, function(data){
