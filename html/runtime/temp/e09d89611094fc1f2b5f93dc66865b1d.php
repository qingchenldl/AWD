<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"D:\wwwroot\154.48.235.148/application/dsadmin/view/index.html";i:1530745692;s:69:"D:\wwwroot\154.48.235.148/application/dsadmin/view/public/header.html";i:1484102488;s:69:"D:\wwwroot\154.48.235.148/application/dsadmin/view/public/footer.html";i:1529869102;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div id="wrapper">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li><a href="<?php echo url('dsadmin/login/loginOut'); ?>">安全退出</a></li>
                        </ul>
                    </div>
                    <div class="logo-element">DS<sup> +</sup>
                    </div>
                </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right"><a href="javascript:;"  target="_blank" style="color:#999">&copy; <?php echo config('WEB_SITE_TITLE'); ?>  V<?php echo config('appbanben'); ?></a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
...
$(document).ready(function(){
    $("#logout").click(function(){
        layer.confirm('你确定要退出吗？', {icon: 3}, function(index){
            layer.close(index);
            window.location.href="<?php echo url('dsadmin/login/loginOut'); ?>";
        });
    });
});
...
$(function(){
    $("#cache").click(function(){
        layer.confirm('你确定要清除缓存吗？', {icon: 3, title:'提示'}, function(index){                   
            $.getJSON("<?php echo url('dsadmin/index/clear'); ?>",function(res){
                if(res.code == 1){
