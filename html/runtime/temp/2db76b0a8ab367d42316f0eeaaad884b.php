<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\wwwroot\154.48.235.148/application/dsadmin/view/member/add_member.html";i:1529997390;s:69:"D:\wwwroot\154.48.235.148/application/dsadmin/view/public/header.html";i:1484102488;s:69:"D:\wwwroot\154.48.235.148/application/dsadmin/view/public/footer.html";i:1529869102;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="add_member" id="add_member" method="post" action="<?php echo url('add_member'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="qq" type="text" class="form-control" name="qq" placeholder="请输入代理qq">
                            </div>
                        </div>
                         <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="weixin" type="text" class="form-control" name="weixin" placeholder="请输入代理微信">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <select class="form-control m-b chosen-select" name="txfeilv" id="txfeilv">
                                   <?php $__FOR_START_24640__=0;$__FOR_END_24640__=101;for($i=$__FOR_START_24640__;$i < $__FOR_END_24640__;$i+=1){ ?>
