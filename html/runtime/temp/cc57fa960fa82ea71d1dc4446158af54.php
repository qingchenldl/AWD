<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\wwwroot\154.48.235.148/application/dsadmin/view/order/index.html";i:1531336858;s:69:"D:\wwwroot\154.48.235.148/application/dsadmin/view/public/header.html";i:1484102488;s:69:"D:\wwwroot\154.48.235.148/application/dsadmin/view/public/footer.html";i:1529869102;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
                 <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('search'); ?>">
                        <div class="col-sm-6">
            ...
            <div class="example-wrap">
                <div class="example">
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr class="long-tr">
                                <th><?php if(!empty($val)): ?>代理id:(<?php echo $val; ?>)_<?php endif; if(!empty($day)): ?><?php echo $day; else: ?>今日<?php endif; ?>订单笔数</th>
                                <th><?php if(!empty($val)): ?>代理id:(<?php echo $val; ?>)_<?php endif; if(!empty($zuori)): ?><?php echo $zuori; else: ?>昨日<?php endif; ?>订单笔数</th>
                                <th><?php if(!empty($val)): ?>代理id:(<?php echo $val; ?>)_<?php endif; if(!empty($day)): ?><?php echo $day; else: ?>今日<?php endif; ?>订单总金额</th>
                                <th><?php if(!empty($val)): ?>代理id:(<?php echo $val; ?>)_<?php endif; if(!empty($zuori)): ?><?php echo $zuori; else: ?>昨日<?php endif; ?>订单总金额</th>
                                <th><?php if(!empty($val)): ?>代理id:(<?php echo $val; ?>)_<?php endif; ?>历史总笔数</th>
                                 <th><?php if(!empty($val)): ?>代理id:(<?php echo $val; ?>)_<?php endif; ?>历史总金额</th>
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        var key=$('#key').val();
        var riqi=$('#riqi').val();
        $.getJSON('<?php echo url("order/index"); ?>', {page: curr || 1,key:key,riqi:riqi}, function(data){
...
//删除订单
function del_yqm(id){
    dashang.confirm(id,'<?php echo url("del_yqm"); ?>');
}

function sc_yqm(){
    dashang.fangwen('<?php echo url("shengcheng"); ?>');
}
