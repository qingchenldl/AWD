<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"D:\wwwroot\154.48.235.148/application/daili/view/login.html";i:1530898234;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <div class="modal-header">
                ...
                <form name="runemail" id="runemail" action="<?php echo url('zhuce'); ?>" method="post">
					...
					<div class="modal-body">
	                    <div class="form-group">
	                    <label>邀请码</label> 
	                    <input type="text"  name="yqm" id="yqm" placeholder="邀请码" class="form-control"></div>
	                </div>
...
$(function(){
	...
	function emailcheckForm(){
		...
		if( '' == $.trim($('#yqm').val())){
			layer.alert('邀请码不能为空', {icon: 5,time:3000});
			$('#yqm').focus(); 
			return false;
		}
